...
(1, DEFAULT, 'R29700'),
(2, DEFAULT, 'R402334'),
(3, 'So teach energy possible believe step. Grow better why child might source.', 'R64'),
(3, 'Front war receive civil single city.', 'R1113'),
(4, DEFAULT, 'R8769'),
(5, DEFAULT, 'R6812');
/* INSERT DATA INTO `appointments` TABLE */
INSERT INTO appointments (app_id, blood_pressure, date, height, notes, patient_id, room_number, temperature, weight) VALUES
(1, '112/61', TIMESTAMP '2021-05-31 04:40:39', 55.7, DEFAULT, 4, 10, 96.8, 242.26),
(2, '105/76', TIMESTAMP '2021-08-12 11:42:05', 72.07, 'Gas Republican and various authority leave right. True include management.', 4, 6, 99.12, 291.98),
(3, '90/65', TIMESTAMP '2020-09-17 12:09:14', 74.79, 'Baby interview senior stop always Congress majority campaign. Various floor itself news experience. Smile represent since method left plant evening.', 1, 3, 97.54, 149.58),
(4, '158/66', TIMESTAMP '2022-01-29 23:42:19', 62.44, DEFAULT, 2, 3, 98.18, 126.95),
(5, '148/92', TIMESTAMP '2021-10-01 18:33:47', 51.49, 'Grow push region produce develop story drive. Film force health lose old case administration.', 3, 0, 99.85, 211.33);
...
(1, 'Early high trouble drive loss turn. Structure your those head. Page single theory.', 4, 'R414', 4),
(2, 'Fast play fact issue radio especially. Get car party close issue. Less politics religious back international risk. College debate direction moment.', 1, 'R87613', 4),
(3, 'Once effect main simply two no. Sister meet though ago. These military part decade.', 3, 'R87629', 1),
(4, 'Growth behind probably arm. Only cup almost identify.', 4, 'R4020', 2),
(4, 'Grow husband short year term. Tough building child usually sea upon full. Body himself home message woman.', 4, 'R0609', 2),
(5, 'High she past especially old. Still quality political other begin war. Evening realize per probably.', 5, 'R29818', 3),
(5, 'Feel military pull watch choice. Free perform civil.', 5, 'R94120', 3);
...
('24000 Erin Point Suite 590\nJosephmouth, NE 49318', '2013-02-28', 'BS5900422', 'hmarsh@example.com', 2, 'Male', 'RN4555', 'Cassandra Bennett', '934-421-7610', 'Nurse', 63897, '137-84-8534'),
...
('76430 Cindy Cove\nSouth Nicholas, FL 14230', '2014-08-03', 'BI0555082', 'brownmichelle@example.net', 4, 'Female', 'PA5773', 'Victoria Hernandez MD', '001-361-534-9263', 'Physician Assistant', 126466, '029-68-7400'),
('Unit 8688 Box 0918\nDPO AP 10509', '2013-08-07', 'BK0024894', 'blakeshane@example.org', 5, 'Female', 'PA7699', 'Susan Harris', '+1-269-471-1801x320', 'Physician Assistant', 121383, '820-20-7549');
...
(1, 5, 'R40236', 'Charge read management production up our. Drug toward such.', 1, 'Analysis care kitchen. Difference range technology serious international position write those.'),
(5, 1, 'R402362', 'Clear newspaper ground just keep. Suffer life chair senior seem west.', 2, 'Decide happy another image because include now. Must plant whether protect most trade. Herself Mr bad wide manage.'),
(4, 2, 'R260', 'Pay growth base age speak pass.', 3, 'Happen letter body language there wonder him. Until direction opportunity very analysis firm once. As year look floor role agency its. Seven those budget involve.'),
(2, 3, 'R4921', 'Enough break factor pattern PM. My full need claim many against television.', 4, 'Yet between night western serious edge. Minute technology only magazine.'),
(4, 3, 'R2240', 'Best student describe concern professional discover.', 5, 'Give especially win give yourself system. Letter finish campaign night simply. Bar standard final. Along particularly factor boy Republican without.');
...
('583 Wallace Ranch\nStewartbury, HI 25324', '2010-01-15', 'kaisernancy@example.com', 'Male', 'Amanda Zavala', 2, '(097)535-1393x3287', '112-39-9032'),
...
('086 Mary Cliff\nNorth Deborah, NE 24135', '2018-10-16', 'leetara@example.net', 'Female', 'John Carlson', 4, '+1-891-013-9916x1510', '127-62-3451'),
